				...
				<div className="relative w-auto my-6 mx-auto max-w-3xl">
					...
					>
						...
						<div className="flex items-center justify-end px-5 pb-5 rounded-b">
							...
							<button
								type="submit"
								className="bg-green-600 text-white font-bold uppercase text-sm px-6 py-3 rounded hover:bg-green-400 outline-none focus:outline-none mr-1 mb-1 transition duration-200 ease"
